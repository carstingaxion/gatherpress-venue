...
function GPQLIcon(iconName) {
  ...
  const NameTagMargin = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.sprintf)('-$%dpx', BaseSize / 4);
  ...
  const NameTagIcon = () => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Icon, {
    icon: "nametag",
    size: NameTagSize
  });
  const OtherIcon = () => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Icon, {
    icon: iconName
  });
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalZStack, {
    offset: 15,
    isLayered: true
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(OtherIcon, null), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    style: {
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(NameTagIcon, null)));
}
...
/* harmony import */ var _components_icon__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/icon */ "./src/components/icon.js");
...
const venuePortalGroup = {
  ...
  // icon: 'nametag',
  icon: (0,_components_icon__WEBPACK_IMPORTED_MODULE_12__["default"])('location'),
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_4__.addFilter)('blocks.registerBlockType', 'gatherpress-venue/extend-group-block', extendGroupBlock);
 ...
 */
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_4__.addFilter)("editor.BlockEdit", "gatherpress-venue/child-block-context-provider", childBlockContextProvider);
