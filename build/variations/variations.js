...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockVariation)('core/group', {
  name: GPV,
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Event venue', 'gatherpress') + ' (v2)',
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Displays the venue for an event.', 'gatherpress'),
  ...
  isActive: ({
    ...
    return className.includes(GPV_CLASS_NAME) // check if className contains GPV_CLASS_NAME and not equals. incase you add additional css classes it will still work
    ;
  },
